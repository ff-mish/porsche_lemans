...
DAT.Globe = function(container, opts) {
  ...
  var pointSize = opts.pointSize || 0.75;
  var Shaders = {
  ...
  function init() {
    ...
    h = container.offsetHeight || window.innerHeight-150;
    ...
    geometry = new THREE.CubeGeometry(pointSize, pointSize, 1);
  ...
  addBackground=function(data) {
      ...
      for (var i = 0, l = data.length; i < l; i += 3) {
          ...
          //size = data[i + 2] /* *200 */;
          size = 0;
          addPoint(lat, lng, size, colorFn(data[i + 2]), backgroundGeometry);
      }
...
//        size = data[i + 2];
  ...
  rotate=function(r) {
    ...
    target.x += r * 0.005 * zoomDamp;
    target.y += 0 * 0.005 * zoomDamp;
