...
l=new THREE.OrthographicCamera(d/e/-2-100/e,d/e/2+100/e,s/e/2+100/e,s/e/-2-100/e,-500,2E3);l.position.set(0,1E3,0);l.up.set(1.42,1,-1).normalize();l.lookAt(new THREE.Vector3(0,0,0));x=new THREE.Object3D;w.add(x);d=new THREE.PlaneGeometry(5,50,2,A);b=new THREE.Mesh(d,new THREE.MeshBasicMaterial({transparent:!0,opacity:1,side:THREE.DoubleSide,alphaTest:.5,overdraw:.5,color:TYPES[0].color}));b.frustumCulled=!1;b.position.set(0,1,0);b.matrixAutoUpdate=!1;b.updateMatrix();b.userData=h;z(b,!1);x.add(b);
d=new THREE.PlaneGeometry(5,50,2,A);c=new THREE.Mesh(d,new THREE.MeshBasicMaterial({transparent:!0,opacity:1,side:THREE.DoubleSide,alphaTest:.5,overdraw:.5,color:TYPES[1].color}));c.frustumCulled=!1;c.position.set(0,1.2,0);c.userData=n;z(c,!1);x.add(c);Q({imageUrl:"image/mobile-infobox.png?"+(new Date).getTime(),opacity:.86,size:15,fixedScaleFactor:.02,finishCallback:function(a){v=a;w.add(v)},drawCallback:function(a,b,c,d){a.fillStyle=TYPES[d.typeIndex].color;a.textBaseline="top";a.font="28pt 'Porsche News Gothic','\u9ed1\u4f53','sans-serif'";
a.fillText(d.name,b+12,c+8);a.font="42pt 'Porsche News Gothic','\u9ed1\u4f53','sans-serif'";a.fillText(""+d.rankings,b+40,c+50);a.font="26pt 'Porsche News Gothic','\u9ed1\u4f53','sans-serif'";a.fillText(rankingsTitle(d.rankings),b+72,c+50);a.font="15pt 'Porsche News Gothic','\u9ed1\u4f53','sans-serif'";a.fillText(""+Math.round(d.speed*B*3600/1E3)+"km/h",b+125,c+58);a.font="14pt 'Porsche News Gothic','\u9ed1\u4f53','sans-serif'";a.fillText("Lap:"+Math.round(d.lap),b+125,c+84)}});window.addEventListener("resize",
r,!1);document.addEventListener("click",u,!1);m();F&&F()})()}})}})}})})()};
