define(function( require , exports , model ){
    ...
    Panel.prototype = {
        ...
        , addSubmitButton : function() {
            ...
            t.createBtnGroup();
            t.$submitButton = $('<button class="lpn_submit btn btn-primary" data-loading-text="提交中..." type="button"><span>' + o.submitText + '</span></button>')
                .appendTo(t.$btnGroup)
                .bind('click', handler)
        ...
        , addCancelButton : function() {
            ...
            t.createBtnGroup();
            t.$cancelButton = $('<button type="button " class="lpn_cancel btn"><span>' + o.cancelText + '</span></button>')
                .appendTo(t.$btnGroup)
                .bind('click', function() {
    ...
    LP.mix( exports , {
        ...
        , panel : function ( options ) {
            ...
            if( top.LP && top.LP != window.LP ){
                return top.LP.panel( options );
            }
