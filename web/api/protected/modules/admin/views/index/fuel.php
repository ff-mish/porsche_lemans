<div class="fuel-container" ng-controller="FuelController">
  ...
  <div class="row">
    <div class="offset8 span2">
      <a href="javascript:void(0)" ng-click="openFuelFormPopup()">添加Fuel</a>
    </div>
  </div>

  <form action="/admin/index/fuel" enctype="multipart/form-data" name="addfuel" method="post" style="display: none;">
