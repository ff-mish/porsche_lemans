...
CREATE TABLE `twittes` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=8389 DEFAULT CHARSET=utf8 COMMENT='发帖表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `uuid` (`uuid`)
) ENGINE=InnoDB AUTO_INCREMENT=101674 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-05-19 14:21:34
