...
CREATE TABLE `score_team` (
  ...
  PRIMARY KEY (`tsid`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='保存团队积分表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `twittes` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=8508 DEFAULT CHARSET=utf8 COMMENT='发帖表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `read_tutorial` int(11) DEFAULT '0',
  PRIMARY KEY (`uid`),
