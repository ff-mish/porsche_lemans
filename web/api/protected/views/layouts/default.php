            ...
            <div class="btn <?php echo Yii::app()->language;?>" id="share"> <span class="label"> <?php echo Yii::t("lemans", "Share")?></span>
                <div class="share-btns">
                    ...
                    <?php else:?>
                        ...
                        <a target="_blank" href="https://twitter.com/intent/tweet?text=Join+my+team!+@Porsche+introduces+%2324SocialRace+the+better+you%27ll+tweet,+the+faster+you%27ll+go!+http://por.sc/24+http://pic.twitter.com/ogvk5Dpfqo" class="i-tw"></a>
